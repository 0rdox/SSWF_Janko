...
namespace Infrastructure {
	...
	public class SeedData {
		...
		public async Task SeedDB() {
			...
			new Packet {Name = "Warme Maaltijd",Products = new List<Product> { products[6] } ,City = CityEnum.Tilburg, Canteen = CanteenEnum.LD, DateTime = DateTime.Now, Price = 14.99m, Type = TypeEnum.WarmeMaaltijd, ReservedById = null, ImageUrl = "https://i.redd.it/5lga7b69n9u41.jpg" },
					new Packet { Name = "Het Avondmaal" , Products = new List<Product> { products[1] }, City = CityEnum.Breda,Canteen = CanteenEnum.LA, DateTime = DateTime.Now.AddDays(1), Price = 8.99m, Type = TypeEnum.WarmeMaaltijd, ReservedById = null, ImageUrl = "https://d2j6dbq0eux0bg.cloudfront.net/images/13721736/820456156.jpg" },
			new Packet { Name = "Stomende Maaltijd" ,Products = new List<Product> { products[4] } , City = CityEnum.Tilburg,Canteen = CanteenEnum.HA, DateTime = DateTime.Now.AddHours(4), Price = 8.99m, Type = TypeEnum.WarmeMaaltijd, ReservedById = null, ImageUrl = "https://5.imimg.com/data5/SELLER/Default/2021/8/PG/VY/TZ/69265562/single-flap-lunch-boxes.jpg" },
			new Packet { Name = "Extra Broodjes" ,Products = new List<Product> { products[6] } , City = CityEnum.Tilburg,Canteen = CanteenEnum.HA, DateTime = DateTime.Now.AddHours(3), Price = 8.99m, Type = TypeEnum.Broodpakket, ReservedById = null, ImageUrl = "https://thefastfoodie.co.uk/wp-content/uploads/2019/11/GF-Sandwich-Diagonal.jpg" },
